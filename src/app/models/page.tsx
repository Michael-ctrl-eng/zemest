...
import { Rabbit, ArrowUpRight } from "lucide-react";
import { RoosterIcon } from "@/components/site/rooster-icon";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        <PageHero
          ...
          description="Each Zemest model is specialized for a language — Rabbit v1 for Arabic, Rooster v1 for English. Together they cover the conversations your customers actually have, in the dialects they actually use."
