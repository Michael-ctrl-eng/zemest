...
const layers = [
  ...
  { icon: Brain, label: "UNDERSTAND", desc: "Knows your products, your prices, your tone — and what's in stock right now." },
      ...
      <div className="mx-auto max-w-[1400px] px-5 sm:px-8">
        <div className="max-w-3xl mb-12">
          ...
          <p className="mt-6 text-base sm:text-lg text-[var(--tavus-hardware-gray-8)] leading-relaxed">
            Every Zemest agent ships with four layers: it sees, hears, understands, and replies — across your WhatsApp, Facebook, and Instagram. It&apos;s not a chatbot. It&apos;s you, scaling.
          </p>
        </div>
