...
export function CTA() {
  return (
    <section
      id="pricing"
      className="relative border-b-2 border-[var(--tavus-terminal-black)] py-16 sm:py-24 overflow-hidden"
    >
      {/* Cloud/sea photo background — same identity as the footer band */}
      <img
        src="/zemest-cloud-sea-cta.avif"
        alt=""
        aria-hidden="true"
        width={1920}
        height={1080}
      ...
      />
      {/* Light haze so the white card pops but the sky stays visible */}
