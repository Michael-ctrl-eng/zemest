      ...
      <div className="mx-auto max-w-[1400px] px-5 sm:px-8">
        <div className="max-w-3xl mb-12">
          ...
          <p className="mt-6 text-base sm:text-lg text-[var(--tavus-hardware-gray-8)] leading-relaxed">
            Each Zemest model is specialized for a language — Rabbit v1 for Arabic, Rooster v1 for English. Together they cover the conversations your customers actually have, in the dialects they actually use.
          </p>
        </div>
