...
export const metadata = { title: "Zemest Blog: Human Computing & Conversational AI" };
...
const posts = [
  ...
  { slug: "what-is-human-computing", category: "AI, NEWS, AND ETHICS", title: "What Is Human Computing? The Research Behind Making AI Feel Human", desc: "Human computing makes AI feel human through perception, timing, and memory. Explore the research foundation.", date: "Aug 10, 2026", gradient: "from-[var(--tavus-floppy-fog-3)] to-[var(--tavus-frost-5)]" },
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        <PageHero
          eyebrow="BLOG"
          title={<>Latest insights in <span className="serif-italic">Human Computing</span></>}
          description="Explore our blogs, research, and updates on Human Computing. Engineering deep-dives, customer stories, and perspectives from the Tavus team."
        />
        ...
        <PageSection bg="grain">
          <div className="text-center">
            ...
            <p className="mt-4 text-base text-[var(--tavus-hardware-gray-8)] max-w-md mx-auto">
              Get the latest from Tavus — engineering deep-dives, customer stories, and research updates — straight to your inbox.
            </p>
