...
export const metadata = { title: "Zemest Research: Pioneering Human Computing" };
...
const papers = [
  ...
  { label: "INTERFACE", title: "The Knowledge Navigator, Reimagined", desc: "Forty years ago, Apple imagined the Knowledge Navigator. Meet Dom, our real-life take on it, and the human computing interface from Tavus that powers him." },
