...
const programs = [
  {
    ...
    title: "Integrate Tavus into your product",
  ...
  },
  {
    ...
    title: "Build on Tavus, free for 12 months",
  ...
  },
  {
    ...
    title: "Co-build the future of human computing",
    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        <PageHero
          ...
          description="Whether you're looking to integrate Tavus into your product, build PALs for your clients, or explore a strategic partnership — we'd love to talk. Connect with us and let's figure out what we can build together."
          ctas={[
