...
export const metadata = { title: "Careers | Tavus — The Human Computing Company" };
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        <PageHero
          eyebrow="CAREERS"
          title={<>Work at <span className="serif-italic">Tavus</span></>}
          description="Join the team decoding conversation. Tavus is an AI research lab reimagining the human and machine interface. We're building the foundations of human computing — AI that sees, hears, and responds with emotion, so talking to a computer feels as natural as talking to a friend."
        ...
        <PageSection bg="grain">
          <div className="text-center mb-10">
            ...
            <h2 className="font-[var(--font-serif-display)] text-4xl sm:text-5xl font-normal tracking-tight text-[var(--tavus-terminal-black)]">
              Life at <span className="serif-italic">Tavus</span>
            </h2>
