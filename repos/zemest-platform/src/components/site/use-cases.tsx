...
const cases = [
  ...
  },
  {
    ...
    image: "/tavus-teaching-machines.avif",
  ...
  },
  {
    ...
    image: "/tavus-v2-portrait.avif",
    stat: { v: "+38%", k: "CSAT" },
  },
  {
    tag: "INVENTORY-AWARE REPLIES",
    label: "INVENTORY AGENT",
    title: "Knows what's in stock before you do",
    desc: "A buyer asks for a pair of shoes in size 42. The agent checks your inventory in real-time and replies: 'Available, 2 left, 850 EGP. Want me to hold one?'",
    image: "/tavus-cvi-eq.avif",
    stat: { v: "-41%", k: "lost sales" },
  },
  {
    tag: "ARABIC + ALL ACCENTS",
    label: "RABBIT V1",
    title: "Arabic, the way your customers actually speak it",
    desc: "Rabbit v1 understands Egyptian, Gulf, Levantine, Maghrebi — every accent and dialect. Replies in the same dialect the customer used, not textbook MSA.",
    image: "/tavus-art-portrait.avif",
    stat: { v: "30+", k: "dialects" },
  },
];
      ...
      <div className="mx-auto max-w-[1400px] px-5 sm:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="mt-6 text-base sm:text-lg text-[var(--tavus-hardware-gray-8)] max-w-2xl mx-auto leading-relaxed">
            An agent can be whatever the moment calls for: a WhatsApp seller, an Instagram DM closer, a Messenger support rep, or an inventory checker. Here are a few ways brands are putting them to work:
          </p>
        </div>
              ...
              >
                ...
                <div className="relative aspect-[4/3] bg-[var(--tavus-terminal-black)] overflow-hidden">
                  ...
                  <div className="absolute inset-0 opacity-20 pointer-events-none" style={{
                    backgroundImage: 'repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(56,242,97,0.15) 2px, rgba(56,242,97,0.15) 3px)'
                  }} />
