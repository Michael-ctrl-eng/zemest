...
const products = [
  ...
  },
  {
    ...
    desc: "Rat v1 handles US, UK, AUS, Indian, and South African English — the way your customers actually speak it. Reads images, listens to voice, replies in your brand tone.",
    cta: "GET STARTED",
...
function ProductVisual({ kind }: { kind: string }) {
  ...
  if (kind === "rat") {
    return (
      <div className="absolute inset-0 bg-[var(--tavus-terminal-black)] p-4 flex flex-col justify-center gap-2">
        <div className="text-[10px] font-mono text-white/40">RAT V1 · ENGLISH</div>
        <div className="bg-white border-2 border-white p-2 text-[11px] text-[var(--tavus-terminal-black)] font-mono">
