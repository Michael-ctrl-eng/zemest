...
const steps = [
  {
    ...
    desc: "Record a 2-minute video. Tavus trains a studio-grade replica of you — voice, face, expressions — in under 10 minutes.",
  },
  {
    n: "02",
    icon: Mic2,
  ...
  },
  {
    ...
    desc: "Embed, share, or trigger via API. Connect HubSpot, Braze, Salesforce, or your own app with one webhook.",
  },
];
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 text-base sm:text-lg text-muted-foreground leading-relaxed">
            No film crew, no editing software, no per-shoot costs. Tavus handles
