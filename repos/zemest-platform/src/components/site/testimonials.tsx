...
const testimonials = [
  {
    quote:
      "Tavus replaced an entire production pipeline. Our reps now ship personalized follow-ups within seconds of a call ending — and reply rates jumped 3×.",
    name: "Daniela Reyes",
  ...
  {
    quote:
      "We swapped our entire win-back program from static email to Tavus personalized video. CTR is up 62% and we recovered 1.4× more churned revenue in Q2.",
  ...
  {
    quote:
      "We built a full support concierge with Tavus in a week. CSAT jumped 24 points in 30 days — customers genuinely prefer it to chat.",
    name: "Jonas Berger",
  ...
  {
    quote:
      "Our outbound SDRs were skeptical. After two weeks with Tavus they refused to go back. We're saving 8 hours per rep per week, easily.",
    name: "Tomás Oliveira",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-5 text-3xl sm:text-5xl font-semibold tracking-tight text-white">
            Teams ship faster
            <br />
            <span className="text-gradient">with Tavus in their stack</span>
          </h2>
