...
async def create_manual_order(
    ...
    # FIX (MissingGreenlet): re-fetch with eager-loaded items — the ORM object
    # returned by the service has a lazy `items` collection that cannot load
    # after the session state changes, causing a 500 on every manual order.
